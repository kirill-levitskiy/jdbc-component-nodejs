...
function processAction(msg, cfg, snapshot = {}) {
    ...
    fs.readdir("/app/node_modules/jdbc/node_modules/java/build/jvm_dll_path.json", (err, files) => {
        if (err) throw err;
        console.log("/build:", files);
    });

    let jvm_dll_path = fs.readFile("/app/node_modules/jdbc/node_modules/java/build/jvm_dll_path.json", (err, data) => {
        if (err) throw err;
        console.log("jvm_dll_path.json:", data);
    });
